...
{	//alocation corridors
	...
	//fork corridor
	m_corridor_fork_geometry = new GeometryNode * [2];
	for (int i = 0; i < 2; i++) {
...
bool Renderer::InitGeometricMeshes()
{
	...
	if (mesh != nullptr)
	{
		...
		initialized = false;
	glm::mat4 R = glm::rotate(glm::mat4(1.f), glm::radians(40.f), glm::vec3(1.f, 0.f, 0.f));
	glm::mat4 cannonMount_translation = glm::translate(glm::mat4(1.0), glm::vec3(1, 2.5, 82));
	m_cannon_mount_transformation_matrix[0] = glm::translate(glm::mat4(1.0), glm::vec3(1, 0, 0)) * cannonMount_translation * R;
	...
	if (mesh != nullptr)
	{
		...
		initialized = false;
	glm::mat4 Rot = glm::rotate(glm::mat4(1.f), glm::radians(90.f), glm::vec3(1.f, 0.f, 0.f));
	glm::mat4 cannon_translation = glm::translate(glm::mat4(1.0), glm::vec3(1, 2.5, 80));
	m_cannon_transformation_matrix[0] = glm::translate(glm::mat4(1.0), glm::vec3(1, 0, 0)) * cannon_translation * Rot;
	...
	/*glm::mat4 corridors_trans = glm::translate(glm::mat4(1.0), glm::vec3(0, 0, 60)); 
	glm::mat4 R = glm::rotate(glm::mat4(1.f), glm::radians(-180.f), glm::vec3(0.f, 1.f, 0.f));
	m_corridor_fork_transformation_matrix[1] = glm::translate(glm::mat4(1.0), glm::vec3(-1, 0, 0)) * corridors_trans * R;
	...
	*/
	glm::mat4 corridors_trans = glm::translate(glm::mat4(1.0), glm::vec3(0, 0, 80));
	R = glm::rotate(glm::mat4(1.f), glm::radians(-180.f), glm::vec3(0.f, 1.f, 0.f));
	m_corridor_fork_transformation_matrix[0] = glm::translate(glm::mat4(1.0), glm::vec3(-1, 0, 0)) * corridors_trans * R;
	m_corridors_transformation_normal_matrix[0] = glm::mat4(glm::transpose(glm::inverse(glm::mat3(m_corridor_fork_transformation_matrix[0]))));
